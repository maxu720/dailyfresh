...
class CheckPayView(LoginRequiredJSONJMixin, View):
    """查询订单状态"""
...
class PayView(LoginRequiredJSONJMixin, View):
    """支付"""
...
class CommitOrderView(LoginRequiredJSONJMixin, TransactionAtomicMixin, View):
    """提交订单"""
    ...
    def post(self, request):
        ...
        if count is None:
            ...
            for sku_id in sku_ids:
                ...
                # 为了方便后续代码的计算和比较,需要先把sku_count,转int
                sku_count = int(sku_count)
