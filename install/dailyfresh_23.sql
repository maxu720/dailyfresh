/*
 ...
 Source Schema         : dailyfresh_23

 Target Server Type    : MySQL
 Target Server Version : 50722
 File Encoding         : 65001

 Date: 13/06/2018 14:57:42
*/
...
CREATE TABLE `auth_group_permissions`  (
  ...
  INDEX `auth_group__permission_id_326202911ab1e00f_fk_auth_permission_id`(`permission_id`) USING BTREE,
  CONSTRAINT `auth_group__permission_id_326202911ab1e00f_fk_auth_permission_id` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `auth_group_permission_group_id_37891b0a01347652_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `auth_permission`  (
  ...
  CONSTRAINT `auth__content_type_id_4abdd6debb149ff2_fk_django_content_type_id` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `df_address`  (
  ...
  `receiver_mobile` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `detail_addr` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `zip_code` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_address_user_id_6808dac90744f824_fk_df_users_id`(`user_id`) USING BTREE,
  CONSTRAINT `df_address_user_id_6808dac90744f824_fk_df_users_id` FOREIGN KEY (`user_id`) REFERENCES `df_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `df_address` VALUES (3, '2018-06-12 09:45:07.679507', '2018-06-12 09:45:07.679646', 'test', 'test', 'test', 'test', 8);
...
CREATE TABLE `df_goods_image`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_goods_image_22ad5bca`(`sku_id`) USING BTREE,
  CONSTRAINT `df_goods_image_sku_id_75ce8a33cdb24519_fk_df_goods_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `df_goods_sku` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `df_goods_sku`  (
  ...
  `default_image` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  `category_id` int(11) NOT NULL,
  `goods_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_goods_sku_category_id_c87ff048768edce_fk_df_goods_category_id`(`category_id`) USING BTREE,
  INDEX `df_goods_sku_goods_id_65edd041dfc86646_fk_df_goods_id`(`goods_id`) USING BTREE,
  CONSTRAINT `df_goods_sku_category_id_c87ff048768edce_fk_df_goods_category_id` FOREIGN KEY (`category_id`) REFERENCES `df_goods_category` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_goods_sku_goods_id_65edd041dfc86646_fk_df_goods_id` FOREIGN KEY (`goods_id`) REFERENCES `df_goods` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of df_goods_sku
-- ----------------------------
INSERT INTO `df_goods_sku` VALUES (1, '2017-10-16 03:10:14.045538', '2017-10-16 03:10:14.045649', '草莓 500g', '草莓简介', '500g', 10.00, 98, 0, 'static/images/goods/goods001.jpg', 1, 1, 1);
INSERT INTO `df_goods_sku` VALUES (2, '2017-10-16 03:11:04.490384', '2017-10-16 03:11:04.490462', '盒装草莓', '草莓简介', '盒', 20.00, 10, 0, 'static/images/goods/goods001.jpg', 1, 1, 1);
INSERT INTO `df_goods_sku` VALUES (3, '2017-10-16 03:12:32.165020', '2017-10-16 03:12:32.165114', '葡萄', '葡萄简介', '500g', 20.00, 7, 0, 'static/images/goods/goods002.jpg', 1, 1, 2);
INSERT INTO `df_goods_sku` VALUES (4, '2017-10-16 03:13:16.457844', '2017-10-16 03:13:16.457926', '柠檬', '简介', '500g', 32.00, 12, 0, 'static/images/goods/goods003.jpg', 1, 1, 3);
INSERT INTO `df_goods_sku` VALUES (5, '2017-10-16 03:14:05.799352', '2017-10-16 03:14:05.799588', '奇异果', '简介', '500g', 12.12, 12, 0, 'static/images/goods/goods004.jpg', 1, 1, 4);
INSERT INTO `df_goods_sku` VALUES (6, '2017-10-16 03:15:09.971968', '2017-10-16 03:15:09.972047', '大青虾', '简介', '500g', 34.00, 12, 0, 'static/images/goods/goods005.jpg', 1, 2, 5);
INSERT INTO `df_goods_sku` VALUES (7, '2017-10-16 03:15:53.812181', '2017-10-16 03:15:53.812292', '北海道秋刀鱼', '简介', '500g', 50.00, 15, 0, 'static/images/goods/goods006.jpg', 1, 2, 6);
...
CREATE TABLE `df_index_category_goods`  (
  ...
  `sku_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_index_cat_category_id_19bdee5083c88d5_fk_df_goods_category_id`(`category_id`) USING BTREE,
  INDEX `df_index_category_goo_sku_id_5a1bd13e4d7c3156_fk_df_goods_sku_id`(`sku_id`) USING BTREE,
  CONSTRAINT `df_index_cat_category_id_19bdee5083c88d5_fk_df_goods_category_id` FOREIGN KEY (`category_id`) REFERENCES `df_goods_category` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_index_category_goo_sku_id_5a1bd13e4d7c3156_fk_df_goods_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `df_goods_sku` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `df_index_goods`  (
  ...
  `sku_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_index_goods_sku_id_59fb549b9bbac669_fk_df_goods_sku_id`(`sku_id`) USING BTREE,
  CONSTRAINT `df_index_goods_sku_id_59fb549b9bbac669_fk_df_goods_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `df_goods_sku` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `df_order_goods`  (
  ...
  `sku_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `df_order_goods_69dfcb07`(`order_id`) USING BTREE,
  INDEX `df_order_goods_22ad5bca`(`sku_id`) USING BTREE,
  CONSTRAINT `df_order_goo_order_id_690e6e8dd6c2931a_fk_df_order_info_order_id` FOREIGN KEY (`order_id`) REFERENCES `df_order_info` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_order_goods_sku_id_7ecd3cc2ead92921_fk_df_goods_sku_id` FOREIGN KEY (`sku_id`) REFERENCES `df_goods_sku` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `df_order_info`  (
  ...
  INDEX `df_order_info_ea8e5d12`(`address_id`) USING BTREE,
  INDEX `df_order_info_e8701ad4`(`user_id`) USING BTREE,
  CONSTRAINT `df_order_info_address_id_213cad3b1a078505_fk_df_address_id` FOREIGN KEY (`address_id`) REFERENCES `df_address` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_order_info_user_id_4d48e7022c8db90_fk_df_users_id` FOREIGN KEY (`user_id`) REFERENCES `df_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `df_users_groups`  (
  ...
  INDEX `df_users_groups_group_id_224629aab5340e5b_fk_auth_group_id`(`group_id`) USING BTREE,
  CONSTRAINT `df_users_groups_group_id_224629aab5340e5b_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_users_groups_user_id_2edd44d3626819b2_fk_df_users_id` FOREIGN KEY (`user_id`) REFERENCES `df_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `df_users_user_permissions`  (
  ...
  INDEX `df_users_us_permission_id_3e6138357cebffc9_fk_auth_permission_id`(`permission_id`) USING BTREE,
  CONSTRAINT `df_users_us_permission_id_3e6138357cebffc9_fk_auth_permission_id` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `df_users_user_permission_user_id_5ca3ead1c4edb007_fk_df_users_id` FOREIGN KEY (`user_id`) REFERENCES `df_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `django_admin_log`  (
  ...
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `djang_content_type_id_786a859f43bd3811_fk_django_content_type_id`(`content_type_id`) USING BTREE,
  INDEX `django_admin_log_user_id_7697e5ae59423ca1_fk_df_users_id`(`user_id`) USING BTREE,
  CONSTRAINT `djang_content_type_id_786a859f43bd3811_fk_django_content_type_id` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `django_admin_log_user_id_7697e5ae59423ca1_fk_df_users_id` FOREIGN KEY (`user_id`) REFERENCES `df_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `django_admin_log` VALUES (3, '2018-06-12 06:01:08.471655', '25', 'test', 1, '', 7, 8);
INSERT INTO `django_admin_log` VALUES (4, '2018-06-12 06:01:34.031188', '25', 'test', 3, '', 7, 8);
INSERT INTO `django_admin_log` VALUES (5, '2018-06-12 06:02:53.647640', '26', 'test', 1, '', 7, 8);
INSERT INTO `django_admin_log` VALUES (6, '2018-06-12 06:44:43.100921', '26', 'test', 3, '', 7, 8);
...
CREATE TABLE `django_content_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `django_content_type_app_label_56f08698eb72265b_uniq`(`app_label`, `model`) USING BTREE
